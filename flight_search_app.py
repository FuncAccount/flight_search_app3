...
# Your Streamlit app code follows
    ...
    if st.button("Search Flights"):
        ...
        # For example, replace this with your actual function calls and logic
        ...
        for _city in all_city:
            temp_dfx = xiecheng2(dcity, _city, date)
        ...
        # html = result_df.to_html(classes=["table", "table-striped", "table-hover"])
